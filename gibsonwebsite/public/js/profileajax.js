...
function load_profile(){
	...
	/*if(user_info.user.primary_phone||user_info.user.secondary_phone)
	{
		...
		personalinfo+='    <div class="row">';
		personalinfo+='        <div class="form-group col-sm-12">';
		personalinfo+='            <p><span class="col-sm-3 fieldname">Phone (Home)</span><span class="col-sm-3 fieldval">' + user_info.user.primary_phone + '</span><span class="col-sm-1 fieldname">Ext</span><span class="col-sm-3 fieldval">' + user_info.user.primary_extension + '</span></p>';
		personalinfo+='        </div>';
		personalinfo+='    </div>';
		personalinfo+='    <div class="row">';
		personalinfo+='        <div class="form-group col-sm-12">';
		personalinfo+='            <p><span class="col-sm-3 fieldname">Phone (Cell)</span><span class="col-sm-3 fieldval">' + user_info.user.secondary_phone + '</span><span class="col-sm-1 fieldname">Ext</span><span class="col-sm-3 fieldval">' + user_info.user.secondary_extension + '</span></p>';
		personalinfo+='        </div>';
		personalinfo+='    </div>';
		} */
	...
	changePassword+='        <div class = "row">';
	changePassword+='            <div class = "col-sm-offset-1 col-sm-10">';
	changePassword+='                <span id="confirmpass" class="confirmpass"></span>';
	changePassword+='            </div>';
	changePassword+='        </div>';
	...
	editinfo+='            </label>';
	editinfo+='            <input class = "form-control col-sm-2" type = "text" name = "primary_phone" id = "editprimary_phone" maxlength="16" pattern="\\w+" value = "' + user_info.user.primary_phone + '">';
	editinfo+='            <input class = "form-control col-sm-2" type = "text" name = "primary_extension" id = "editprimary_extension" maxlength="16" pattern="\\w+" value = "' + user_info.user.primary_extension + '">';
	editinfo+='        </div>';
	editinfo+='        <div class="form-group col-sm-5">';
	editinfo+='            <label class="editfieldname col-sm-12">';
	...
	editinfo+='            </label>';
	editinfo+='            <input class = "form-control col-sm-2" type = "text" name = "secondary_phone" id = "editsecondary_phone" maxlength="16" pattern="\\w+" value = "' + user_info.user.secondary_phone + '">';
	editinfo+='            <input class = "form-control col-sm-2" type = "text" name = "secondary_extension" id = "editsecondary_extension" maxlength="16" pattern="\\w+" value = "' + user_info.user.secondary_extension + '">';
	editinfo+='        </div>';
	editinfo+='        <div class="form-group col-sm-5">';
	editinfo+='            <label class="editfieldname col-sm-12">';
	editinfo+='                <p>Phone (Home) Ext.: </p>';
	...
	for(var i=0; i<user_info.emergency_contacts.length; i++)
	{
		...
		editinfo+='                <p>Phone: </p>';
		editinfo+='            </label>';
		editinfo+='            <input type = "text" class = "form-control col-sm-2" name =  "ephone' + (i+1) + '" id = "ephone' + (i+1) + '" maxlength="16" pattern="\w+" value = "' + user_info.emergency_contacts[i].contact_phone + '">';
		editinfo+='            <input type = "text" class = "form-control col-sm-1" name =  "ephoneextension' + (i+1) + '" id = "ephoneextension' + (i+1) + '" maxlength="16" pattern="\w+" value = "' + user_info.emergency_contacts[i].contact_phone_extension + '">';
		editinfo+='        </div>';
		editinfo+='    </div>';
		editinfo+='</div>';
	}
...
function editpersonalinfo() {
	jQuery.getJSON("/user/profile/info", function(user_info){
		...
		editinfo+='    <div id="page-content-wrapper" class="container-fluid xyz">';
	    editinfo+='    <div class="row">';
	    editinfo+='        <h3 class="col-sm-8">Personal Information</h3>';
	    editinfo+='    </div>';
		editinfo+='    <form class="form-inline" name="editinformation" id="editinformation" action="/user/profile/edit" method="POST" role="form">';
		editinfo+='    <input type="hidden" name="username" id="username" value="' + user_info.user.username + '">';
		editinfo+='            <input type = "hidden" name="_csrf" value="'+ $('#_csrf').val() +'">';
...
function editstudentinfo() {
	jQuery.getJSON("/user/profile/info", function(user_info){
		...
		{
		    editinfo+='    <div class="row">';
		    editinfo+='        <h3 class="col-sm-8">Student Information</h3>';
	    	editinfo+='    </div>';
			editinfo+='    <div class="row">';
			editinfo+='        <div class="form-group col-sm-5">';
			editinfo+='            <label class="editfieldname col-sm-12">';
...
function editcontactsinfo() {
	jQuery.getJSON("/user/profile/info", function(user_info){
		...
		editinfo+='	  <div id="page-content-wrapper" class="container-fluid xyz">';
	    editinfo+='    <div class="row">';
	    editinfo+='        <h3 class="col-sm-8">Emergency Contacts</h3>';
    	editinfo+='    </div>';
		// The user's existing emergency contacts
		for(var i=0; i<user_info.emergency_contacts.length; i++)
		{
...
function showFilteredCourses(data, searchText, searchTags){
	...
	for(var i = 0; i < data.length; i++) {
		...
		courses += '        	    	</div>';
		courses += '            		<div class="col-sm-12 addbutton">';
...
function listschedule(){
	jQuery.getJSON("/user/profile/schedule", function(data){
		...
		for(i = 0; i < data.length; i++) {
            ...
            //*** AJAX for Generating Language ***//
            schedule += '        		<div class="row largemargin">';
            schedule += '        	    	<div class="col-sm-2">';
            schedule += '        	        	 <p id="courselanguagetitle' + i + '"><b>Languages:</b></p>';
            schedule += '         	   		</div>';
            ...
            if(data[i].course_language != null){
                ...
                for(var j = 0; j < JSON.parse(data[i].course_language).length; j++){
                    lang += JSON.parse(data[i].course_language)[j] + ", ";
                }

                lang = lang.slice(0, -2);
                schedule += '            		<div class="col-sm-12">';
                schedule += '                 		<p id="courselanguages">'+ lang +'</p>';
            	schedule += '            		</div>';
            }
