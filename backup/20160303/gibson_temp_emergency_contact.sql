...
CREATE TABLE `temp_emergency_contact` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Emergency contacts for each user - may have more than 1 per user';
...
INSERT INTO `temp_emergency_contact` VALUES (1,1,'Sagad','At','This','123','2016-03-03 06:09:20'),(2,1,'Sagad','At','This','123','2016-03-03 06:09:20');
