...
CREATE TABLE `website_alert` (
  ...
  `alert_type` enum('SLOW','MAINTENANCE','ANNOUNCEMENT') COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `website_alert` VALUES (4,'2016-04-08 04:00:00','2016-04-07 05:59:08','SERVER MAINTENANCE GOING DOWN AT 12:00 AM SATURDAY','MAINTENANCE',1);
